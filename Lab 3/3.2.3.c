...
Version 2.7 --- 5/14/2020 15:24:36 PST
*/
...
unsigned char btn_g;
const unsigned char seq[5] = {3,2,1,5,4};
unsigned char i;
unsigned char light;
unsigned char btn;
unsigned char timer;
...
enum DS_States { DS_Init, DS_Start, DS_Wait, DS_Match, DS_Check, DS_Fail, DS_OnOpen } DS_State;
